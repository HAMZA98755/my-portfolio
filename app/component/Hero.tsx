...
export default function Hero() {
  ...
  return (
    // Start Hero Section 
    <section className="py-8 bg-linear-to-r">
      {/* Start Container  */}
      <div className="container  gap-8 text-center">
        ...
        <div className="max-w-5xl w-full h-[calc(100vh-10rem)] flex flex-col justify-between">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight md:flex items-center gap-4">
            ...
            <div className={`${isArabic ? 'md:text-left': 'md:text-right'}`}>
              ...
              {/*  */}
              <p className='mt-3 text-sm md:text-base ' style={{color: colors.textSecondary}}>{t.homePage.tagLine}</p>
            </div>
            {/* Start Description  */}
          </div>
